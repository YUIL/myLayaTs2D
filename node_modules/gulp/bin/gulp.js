...
require = function(path){
    console.time(`laya_ide_time.require.single.${path}`);
    var re = rtemp(path);
    console.timeEnd(`laya_ide_time.require.single.${path}`);
    return re;
}
console.time("laya_ide_time.gulp.all.require");
...
console.timeEnd("laya_ide_time.gulp.all.require");
console.time("laya_ide_time.gulp.exec");
...
function logEvents(gulpInst) {
  ...
  gulpInst.on('task_start', function(e) {
    console.time(`laya_ide_time.gulp.task${e.task}`);
    // TODO: batch these
  ...
  gulpInst.on('task_stop', function(e) {
    console.timeEnd(`laya_ide_time.gulp.task${e.task}`);
    ...
    // $LayaFlag
    // 获取gulp tasks执行序列列表
    var tasksTotalLength = gulpInst.seq.length;
    if (++tasksFinished >= tasksTotalLength) {
      console.log("laya.ide.complete");
    }
  });
...
console.timeEnd("laya_ide_time.gulp.exec");