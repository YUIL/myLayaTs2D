...
// const isPlainObject = require('is-plain-object'); // $LayaFlag
// const mapValues = require('object.map'); // $LayaFlag
// const fined = require('fined'); // $LayaFlag

const findCwd = require('./lib/find_cwd');
// const findConfig = require('./lib/find_config'); // $LayaFlag
// const fileSearch = require('./lib/file_search'); // $LayaFlag
...
Liftoff.prototype.buildEnvironment = function (opts) {
  ...
  try {
    ...
    modulePackage = silentRequire(path.join(__dirname, "../", "gulp", "package.json"));
  } catch (e) {}
